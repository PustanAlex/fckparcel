...
var _galleryItems = require("../js/gallery-items");
...
document.addEventListener("DOMContentLoaded", function() {
    const gallery = document.querySelector(".gallery");
    gallery.addEventListener("click", function(e1) {
        e1.preventDefault();
        if (e1.target.tagName === "IMG") {
            const source = e1.target.dataset.source;
            const instance = (0, _simplelightboxDefault.default).open(`<img src="${source}" alt="Image description">`);
...
},{"simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","../js/gallery-items":"9C7dK","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9ydBq":[function(require,module,exports) {
/*!
...
},{}]},["8EXaa","6XVkV"], "6XVkV", "parcelRequire37e1")
